...
namespace CDKTTCTN.Services.ExportImport
{
    ...
    public class PropertyByName<T>
    {
        ...
        public object PropertyValue
        {
            get
            {
                return IsDropDownCell ? GetItemId(_propertyValue) :
                    _propertyValue;
            }
            set
            {
        ...
        public Guid GuidValue
        {
            ...
            {
                Guid rez;
                if (PropertyValue == null || !Guid.TryParse(PropertyValue.ToString(), out rez))
                    return default(Guid);
                return rez;
            }
        }
        ...
        public double DoubleValueWithComma
        {
            get
            {
                double rez;
                if (PropertyValue == null || !double.TryParse(PropertyValue.ToString().Replace(',', '.'), out rez))
                    return default(double);
                return rez;
            }
        }
